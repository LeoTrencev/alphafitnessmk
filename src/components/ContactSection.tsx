      ...
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="mt-6 rounded-lg overflow-hidden border border-border h-[250px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2975.5!2d22.4632!3d41.6381!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDHCsDM4JzE3LjIiTiAyMsKwMjcnNDcuNSJF!5e0!3m2!1sen!2smk!4v1"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-card border border-border text-foreground font-body focus:outline-none focus:border-primary transition-colors"
                  required
                />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-3 rounded-lg bg-card border border-border text-foreground font-body focus:outline-none focus:border-primary transition-colors resize-none"
                  required
                />
              </div>
              <button
