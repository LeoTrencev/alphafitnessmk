...
const translations: Translations = {
  ...
  "about.feature2.title": { mk: "Професионални тренери", en: "Professional Trainers" },
  "about.feature2.desc": { mk: "Сертифицирани тренери кои ќе ви помогнат да ги постигнете вашите цели", en: "Certified trainers who will help you achieve your goals" },
  ...
  "pricing.daily": { mk: "Дневна", en: "Daily" },
  "pricing.biweekly": { mk: "2 Недели", en: "2 Weeks" },
  "pricing.monthly": { mk: "Месечна", en: "Monthly" },
  "pricing.quarterly": { mk: "3 Месеци", en: "3 Months" },
  "pricing.yearly": { mk: "Годишна", en: "Yearly" },
  "pricing.den": { mk: "ден", en: "den" },
  "pricing.perDay": { mk: "/ ден", en: "/ day" },
  "pricing.perPeriod": { mk: "/ период", en: "/ period" },
  ...
  "pricing.feature2": { mk: "Гардероба и туш", en: "Locker room & shower" },
  "pricing.feature3": { mk: "Бесплатен паркинг", en: "Free parking" },
  "pricing.select": { mk: "Избери план", en: "Select Plan" },
