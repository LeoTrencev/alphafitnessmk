...
const translations: Translations = {
  ...
  "hero.cta": { mk: "Ценовник", en: "Pricing" },
  ...
  "contact.subtitle": { mk: "КОНТАКТ И ЛОКАЦИЈА", en: "CONTACT & LOCATION" },
  "contact.title": { mk: "Контакт и локација", en: "Contact & Location" },
  ...
  "footer.followUs": { mk: "Заследи не и на", en: "Follow us on" },
};
